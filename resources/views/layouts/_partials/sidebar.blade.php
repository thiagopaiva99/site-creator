<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li>
                    <a href="{{ 'sites' }}" class="waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-wordpress"></i><span class="hide-menu">Sites Wordpress</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ 'projetcs' }}" class="waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-exit-to-app"></i><span class="hide-menu">Sair</span></a>
                </li>
            </ul>
        </nav>
